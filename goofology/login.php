...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td width="55%" class="column2"><p>
    	<?php $colType='big'; include 'phpmodules/memberLogin.php'; ?>
    	</p>
      <p>&nbsp;</p>
      <p>
        <?php $numberOfLinks=5; include 'phpmodules/newestLinks.php'; ?>
</p>
      <p>&nbsp;</p>
      <p>
        <?php $numberOfLinks=5; include 'phpmodules/popularLinks.php'; ?>
      </p>
      <p><br />
      </p></td>
    <td width="25%" class="column3">
      ...
      <p>&nbsp;</p>
      <p>
        <?php $colType='small'; $numberOfMembers='10'; include 'phpmodules/newestMembers.php'; ?>
        <br />
      </p></td>
  </tr>
  <tr>
