...
<link href="../../../../templates/cssincludes/goof.css" rel="stylesheet" type="text/css" />
</head>
...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF">
      ...
      <tr>
        <td rowspan="2" width="100%"><div align="center">
          <table width="300" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td><a href="http://www.goofology.com"><img src="../../../../templates/images/gooflogo.png" alt="Goofology.com" name="goofLogo" width="350" height="150" border="0" id="goofLogo" longdesc="http://www.goofology.com"/></a></td>
            </tr>
          </table>
          </div></td>
  ...
  <tr>
    <td height="40" align="center" valign="middle"><form id="form1" name="form1" method="get" action="../../../../templates/search.php">
      <label>
  ...
  <tr>
    <td width="20%" class="column1"><p>
      <?php include '../../../../templates/phpmodules/navigationMenu.php'; ?>
    </p>
      <p><br />
        </p>
      <?php $colType='small'; include '../../../../templates/phpmodules/randomLinks.php'; ?></td>
    <td width="55%" class="column2"><p>
    	<?php $numberOfLinks=5; include '../../../../templates/phpmodules/newestLinks.php'; ?>
        </p>
      <p>&nbsp;</p>
      <p>
        <?php $numberOfLinks=5; include '../../../../templates/phpmodules/popularLinks.php'; ?>
          </p>
      <p>&nbsp;</p>
      <p>
        <?php $numberOfLinks=5; include '../../../../templates/phpmodules/highestRatedLinks.php'; ?>
        <br />
      </p></td>
    <td width="25%" class="column3">
      <p>
        <?php $colType='small'; include '../../../../templates/phpmodules/memberStats.php'; ?>
        </p>
      <p>&nbsp;</p>
      <p>
        <?php $colType='small'; include '../../../../templates/phpmodules/highestGP.php'; ?>
        </p>
      <p>&nbsp;</p>
      <p>
        <?php $colType='small'; include '../../../../templates/phpmodules/newestMembers.php'; ?>
        <br />
      </p></td>
  </tr>
  <tr>
