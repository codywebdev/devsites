...
require_once ("/home/gearscores/public_html/includes/opendb.php");
	...
	//$name = 'Xav'; $server = 'Sen\'Jin'; $region = 'us';
	...
	//html
	$expHtml .= '<tr> <td class="raidName">The Ruby Sanctum</td> <td align="right" onmousemove="$WowheadPower.moveTooltip(event)" onmouseout="$WowheadPower.hideTooltip();" onmouseover="$WowheadPower.showTooltip(event,'.htmlspecialchars($Points10mTooltip).',\'\');" class="'.((floor(min(($Points10m/$PointsReq10m),1)*100) > 50)? ((floor(min(($Points10m/$PointsReq10m),1)*100) > 90)? 'green' : 'orange' ) : 'red' ).'RaidExp">'.floor(min(($Points10m/$PointsReq10m),1)*100).'%</td> <td align="right" onmousemove="$WowheadPower.moveTooltip(event)" onmouseout="$WowheadPower.hideTooltip();" onmouseover="$WowheadPower.showTooltip(event,'.htmlspecialchars($Points10hTooltip).',\'\');" class="'.((floor(min(($Points10h/$PointsReq10h),1)*100) > 50)? ((floor(min(($Points10h/$PointsReq10h),1)*100) > 90)? 'green' : 'orange' ) : 'red' ).'RaidExp">'.floor(min(($Points10h/$PointsReq10h),1)*100).'%</td> <td align="right" onmousemove="$WowheadPower.moveTooltip(event)" onmouseout="$WowheadPower.hideTooltip();" onmouseover="$WowheadPower.showTooltip(event,'.htmlspecialchars($Points25mTooltip).',\'\');" class="'.((floor(min(($Points25m/$PointsReq25m),1)*100) > 50)? ((floor(min(($Points25m/$PointsReq25m),1)*100) > 90)? 'green' : 'orange' ) : 'red' ).'RaidExp">'.floor(min(($Points25m/$PointsReq25m),1)*100).'%</td> <td align="right" onmousemove="$WowheadPower.moveTooltip(event)" onmouseout="$WowheadPower.hideTooltip();" onmouseover="$WowheadPower.showTooltip(event,'.htmlspecialchars($Points25hTooltip).',\'\');" class="'.((floor(min(($Points25h/$PointsReq25h),1)*100) > 50)? ((floor(min(($Points10m/$PointsReq10m),1)*100) > 90)? 'green' : 'orange' ) : 'red' ).'RaidExp">'.floor(min(($Points25h/$PointsReq25h),1)*100).'%</td> </tr>';
	...
	if ($charExp['category']['statistic'][108]['quantity']) $Points10m += 30;
	//25m
	$PointsReq25m = 140;
	...
	$Points25mTooltip = '"'.$Points25m.' / '.$PointsReq25m.'<br/><table>'.
						...
						'</table>"';
	//html
	$expHtml .= '<tr> <td class="raidName">Ulduar</td> <td align="right" onmousemove="$WowheadPower.moveTooltip(event)" onmouseout="$WowheadPower.hideTooltip();" onmouseover="$WowheadPower.showTooltip(event,'.htmlspecialchars($Points10mTooltip).',\'\');" class="'.((floor(min(($Points10m/$PointsReq10m),1)*100) > 50)? ((floor(min(($Points10m/$PointsReq10m),1)*100) > 90)? 'green' : 'orange' ) : 'red' ).'RaidExp">'.floor(min(($Points10m/$PointsReq10m),1)*100).'%</td> <td></td> <td align="right" onmousemove="$WowheadPower.moveTooltip(event)" onmouseout="$WowheadPower.hideTooltip();" onmouseover="$WowheadPower.showTooltip(event,'.htmlspecialchars($Points25mTooltip).',\'\');" class="'.((floor(min(($Points25m/$PointsReq25m),1)*100) > 50)? ((floor(min(($Points25m/$PointsReq25m),1)*100) > 90)? 'green' : 'orange' ) : 'red' ).'RaidExp">'.floor(min(($Points25m/$PointsReq25m),1)*100).'%</td> <td></td> </tr>';
	...
	//tooltips
	$Points10mTooltip = '"'.$Points10m.' / '.$PointsReq10m.'<br/><table><tr><td align=\'right\' style=\'padding-right: 4px\'>'.$charExp['category']['statistic'][92]['quantity'].'</td><td>Sartharion kills</td></tr></table>"';
	$Points25mTooltip = '"'.$Points25m.' / '.$PointsReq25m.'<br/><table><tr><td align=\'right\' style=\'padding-right: 4px\'>'.$charExp['category']['statistic'][93]['quantity'].'</td><td>Sartharion kills</td></tr></table>"';
	//html
	$expHtml .= '<tr> <td class="raidName">Sartharion</td> <td align="right" onmousemove="$WowheadPower.moveTooltip(event)" onmouseout="$WowheadPower.hideTooltip();" onmouseover="$WowheadPower.showTooltip(event,'.htmlspecialchars($Points10mTooltip).',\'\');" class="'.((floor(min(($Points10m/$PointsReq10m),1)*100) > 50)? ((floor(min(($Points10m/$PointsReq10m),1)*100) > 90)? 'green' : 'orange' ) : 'red' ).'RaidExp">'.floor(min(($Points10m/$PointsReq10m),1)*100).'%</td> <td></td> <td align="right" onmousemove="$WowheadPower.moveTooltip(event)" onmouseout="$WowheadPower.hideTooltip();" onmouseover="$WowheadPower.showTooltip(event,'.htmlspecialchars($Points25mTooltip).',\'\');" class="'.((floor(min(($Points25m/$PointsReq25m),1)*100) > 50)? ((floor(min(($Points25m/$PointsReq25m),1)*100) > 90)? 'green' : 'orange' ) : 'red' ).'RaidExp">'.floor(min(($Points25m/$PointsReq25m),1)*100).'%</td> <td></td> </tr>';
	...
	if ($charExp['category']['statistic'][73]['quantity']) $Points10m += 65;
	//25m
	$PointsReq25m = 130;
